...
The function \fct{loglik} returns a vector giving the value of the loglikelihood 
for each sequence.
...
The function \fct{aic} returns vector giving the value of the AIC for each sequence.
...
The function \fct{bic} returns vector giving the value of the BIC for each 
sequence.
...
# Computation of  the log-likelihood
loglik(x = estmarkov, sequences = seqmarkov, states = states)
@
...
<<aicestmarkov>>=
# Computation of the AIC
aic(x = estmarkov, sequences = seqmarkov, states = states)
@
...
\paragraph{Values:}
The function \fct{bic} returns vector giving the value of the BIC for each sequence.
