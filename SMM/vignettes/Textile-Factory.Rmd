...
```{r}
trueBMP <- failureRateBMP(x = factory, k = k, upstates = upstates)
estBMP <- failureRateBMP(x = estimate, k = k, upstates = upstates)
```
...
```{r}
trueRG <- failureRateRG(x = factory, k = k, upstates = upstates)
estRG <- failureRateRG(x = estimate, k = k, upstates = upstates)
```
...
```{r}
trueMTTR <- mttr(x = factory, downstates = downstates)
estMTTR <- mttr(x = estimate, downstates = downstates)
```
